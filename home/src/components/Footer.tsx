            ...
            <div className="relative">
                ...
                <div className="flex flex-col md:flex-row relative bg-background z-10 p-4 md:px-8 lg:px-24 py-6 gap-4 md:gap-8">
                    ...
                    <div className="space-y-4 md:space-y-8 flex flex-col w-full md:w-[60%] lg:w-[55vw] justify-center">
                        ...
                        {/* Institute Logos */}
                        <h1 className="font-semibold">We are Recognized by</h1>
                        <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                            {institutes.map((institute, index) => (
                                <img
                                    ...
                                    src={institute.src}
                                    alt={institute.alt}
                                    className="lg:w-16 h-16 bg-white md:w-12 md:h-12  hover:scale-105 transition-transform rounded-md object-contain"
                                />
                            ))}
                        </div>
                    </div>
