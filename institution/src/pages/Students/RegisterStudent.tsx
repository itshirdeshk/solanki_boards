...
import { instituteDetailsSelector } from '@/store/atoms/instituteAtoms';
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      // Always append instituteId from localStorage for backend
      data.append('instituteId', localStorage.getItem('id') || '');
  ...
  const forms: Record<FormType, JSX.Element> = {
    //@ts-expect-error RegisterStudentForm expects more props than defined in the type
    student: <RegisterStudentForm setCourseType={setCourseType} courses={courses} courseError={courseError} courseType={courseType} isLoadingCourses={isLoadingCourses} setSelectedCourse={setSelectedCourse} instituteName={instituteDetails?.centerName || ''} />,
