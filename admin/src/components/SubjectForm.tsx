...
interface SubjectFormProps {
    ...
    providedDeclarationName: string;
}

const SubjectForm = ({ setIsDeclarationComplete, providedDeclarationName }: SubjectFormProps) => {
    ...
    const [declarationName, setDeclarationName] = useState(providedDeclarationName);
