...
import { Search, Loader2, CreditCard, CheckCircle2, Clock } from "lucide-react";
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p className={`flex items-center gap-2 ${studentData.paymentStatus === PaymentStatus.SUCCESS ? 'text-green-600' : 'text-red-600'}`}>
                                    {studentData.paymentStatus === PaymentStatus.SUCCESS ? (
                                        <>
