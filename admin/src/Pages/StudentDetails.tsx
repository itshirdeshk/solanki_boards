...
import { getstudentbyid, updateAdmission, deleteAdmission, getcoursebyid, paymentApproved, getallcourse } from '@/Config'
              ...
              <div>
                ...
                {isEditing ? (
                  <Select
                    ...
                    onValueChange={val => handleEditChange('courseId', val)}
                    // Only fetch when opened
                    onOpenChange={open => {
                      if (open && !coursesLoaded && !coursesLoading) {
                    ...
                    <SelectContent>
                      {coursesLoading ? (
                        <div className="flex items-center justify-center p-4">
                          <Loader2 className="animate-spin h-5 w-5 mr-2" /> Loading courses...
                        </div>
                      ) : courses.length > 0 ? (
                        courses.map(course => (
