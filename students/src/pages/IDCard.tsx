    ...
    useEffect(() => {
        const fetchStudentData = async () => {
            try {
                ...
                setStudentData(data);
                setPhotoDataUrl(data.studentPhoto);

                // Convert student photo to data URL if available
                if (data && data.studentPhoto) {
                    try {
                        const imgRes = await fetch(data.studentPhoto, { mode: 'cors' });
                    ...
                    <div
                        ...
                        <div className="absolute mt-[330px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                            {studentData.studentPhoto ? (
                                <img
                                    src={photoDataUrl || studentData.studentPhoto}
                                    alt="Student"
