    ...
    <div className="max-w-3xl mx-auto my-10">
      ...
      <div className="mt-10 bg-yellow-50 border-l-4 border-yellow-400 p-5 rounded-lg shadow-sm">
        <div className="mb-3">
          ...
          <span className="ml-2 text-gray-800">Learners opting for more than 5 subjects: <span className="font-semibold">Best of 5 subjects with 1 language will be considered.</span> Marks for 5 subjects will be calculated accordingly.</span>
        </div>
        <div className="mb-2">
          <span className="font-bold text-red-700">Important Disclaimer:</span>
        </div>
        <ul className="list-disc pl-6 text-gray-700 space-y-1">
          <li>Unfair Means (UFM) will lead to the cancellation of results or disqualification.</li>
          <li>Neither SBCODL nor its IT Section is responsible for any inadvertent error that may have crept into the results being published online.</li>
          <li>The results published on the internet are for immediate information only and cannot be treated as original marksheets.</li>
          <li>Original marksheets will be issued separately by the Council.</li>
        </ul>
      </div>
    </div>
  );
